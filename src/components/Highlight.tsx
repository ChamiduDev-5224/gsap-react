...
export const Highlight = () => {
    ...
    return (
        <section className='min-h-[100vh] mt-4 md:mt-16'>
            <div>
                <h2 className='text-default text-5xl font-semibold my-4 text-center'>iPhone 15 Pro</h2>
                <video autoPlay muted playsInline={true} key={videoSrc}>
                    <source src={videoSrc} type='video/mp4' />
                </video>
            </div>

            <div id='get_start' className='flex flex-col items-center opacity-0'>
